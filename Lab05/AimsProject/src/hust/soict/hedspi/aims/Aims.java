...
public class Aims {
	...
	public void originalMenuLoop() throws PlayerException {
        int option0 = -1;
        while (option0 != 0) {
            showMenu();
    ...
    public void storeMenuLoop() throws PlayerException {
        int option1 = -1;
        while (option1 != 0) {
            store.print();
            storeMenu();
    ...
    public void askMediaLoop() throws PlayerException {
    	boolean valid = false;
    	while (valid == false) {
    ...
    public void mediaDetailsLoop(Media selected) throws PlayerException {
        int option2 = -1;
        while (option2 != 0) {
        	mediaDetailsMenu();
    ...
    public void playMediaLoop() throws PlayerException {
    	boolean valid = false;
    	while (valid == false) {
    		System.out.println("Please enter the title:");
    		String title = scanner.nextLine();
    ...
    public void updateStoreLoop() throws PlayerException {
        int option3 = -1;
        while (option3 != 0) {
        	updateStoreMenu();
    ...
    public void addMediaLoop() throws PlayerException {
        int option4 = -1;
        while (option4 != 0) {
        	addMediaMenu();
    ...
    public void removeMediaLoop() throws PlayerException {
        int option5 = -1;
        while (option5 != 0) {
        	removeMediaMenu();
    ...
    public void cartMenuLoop() throws PlayerException {
        int option6 = -1;
        while (option6 != 0) {
        	cartMenu();
    ...
    public void filterCartLoop() throws PlayerException {
        int option7 = -1;
        while (option7 != 0) {
        	filterMenu();
    ...
    public void sortCartLoop() throws PlayerException {
        int option8 = -1;
        while (option8 != 0) {
        	sortMenu();
    ...
    public void removeMediaCartLoop() throws PlayerException {
        int option9 = -1;
        while (option9 != 0) {
        	removeMediaMenu();
    ...
    public void playMediaCartLoop() throws PlayerException {
    	boolean valid = false;
    	while (valid == false) {
    		System.out.println("Please enter the title:");
    		String title = scanner.nextLine();
